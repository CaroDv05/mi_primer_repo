...
Si queremos añadir una nota al pie directamente en el nombre de una columna, en 
locations usamos la función
...
c. Agregue títulos, subtítulos, fuente y pie de tabla al cuadro obtenido. Recuerde
usar ?airquality para obtener información sobre el origen de los datos.
